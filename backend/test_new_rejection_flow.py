#!/usr/bin/env python3
"""
New test script for the rejection system flow with accept_reject boolean.
This script simulates the entire rejection process using the updated review task system.
"""
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('test_new_rejection.log')
    ]
)
...
def create_test_users():
    ...
    try:
        # Create test users
        test_users = [
            ('new_reject_contributor', 'new_reject_contributor@test.com', 'testpass123'),
            ('new_reject_reviewer1', 'new_reject_reviewer1@test.com', 'testpass123'),
            ('new_reject_reviewer2', 'new_reject_reviewer2@test.com', 'testpass123'),
        ]
    ...
    try:
        ...
        cursor.execute("""
            INSERT INTO tasks (
                ...
                'New Test Rejection Task', 
                'A test task to demonstrate the new rejection system with accept_reject',
                'open',
                %s,
                2
            ) RETURNING id
        ...
        logger.info(f"  Title: New Test Rejection Task")
...
def setup_user_skills(user_id, skill_ids, initial_rating=4.0):
    ...
    try:
        for i, assignment_id in enumerate(review_assignment_ids):
            ...
            """, (
                ...
                feedback,
                "Minor improvements needed" if accept_reject else "Multiple critical issues",
                assignment_id
            ))
...
def check_rejection_results(task_id, contributor_id):
    ...
    print("\n" + "="*60)
    print("CHECKING NEW REJECTION SYSTEM RESULTS")
    print("="*60)
    ...
    try:
        ...
        # Check if user is blocked (should be blocked for rejection)
        ...
        # Check user skill ratings (should be decreased)
        ...
        # Check total users blocked from this task
        ...
        print("- Majority of reviews should be 'REJECT'")
        print("- Original contributor should be blocked for 30 days")
        print("- User skill ratings should be decreased")
...
def test_new_rejection_flow():
    """Main test function."""
    logger.info("🚀 Starting New Rejection System Test")
    print("🚀 Starting New Rejection System Test")
    print("="*60)
    ...
    try:
        ...
        setup_user_skills(contributor['id'], skill_ids, initial_rating=4.0)
        ...
        # Step 7: Submit reviews (majority reject)
        logger.info("Step 7: Submitting reviews...")
        print("\n7. Submitting reviews (majority reject scenario)...")
        # Both reviewers reject
        accept_reject_list = [False, False]  # Both reject
        ...
        check_rejection_results(task_id, contributor['id'])
        ...
        logger.info("🎉 New rejection test completed successfully!")
        print("\n🎉 New rejection test completed successfully!")
        print("\nTo test in the UI:")
